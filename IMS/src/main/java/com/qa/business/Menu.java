...
public class Menu {
	...
	public void enterBook() {
		...
		do {
			...
			System.out.println("Add publish date (YYYY-MM-DD)");
			book.setPublishDate(scan.inputString());

			System.out.println("Add price (e.g 21.0)");
	...
	public void enterOrder() {
		...
		do {
			...
			System.out.println("Add order date (YYYY-MM-DD)");
			order.setOrderDate(scan.inputString());

			System.out.println("Add quantity ordered");
